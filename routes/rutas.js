...
rutas.get('/buscarreservas')
rutas.get('/buscarreserva/:idreserva')
rutas.post('/registrarreservacion')
rutas.put('/editarreservacion/:idreserva')
rutas.delete('/eliminarreservacion/:idreserva')
